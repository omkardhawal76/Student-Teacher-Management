                ...
                <div class="col-md-9" >
                    ...
                    <div class="row row-cols-1" style="padding-top: 10px;">
                        ...
                        <div class="col" id="nav">
                            ...
                            <nav class="navbar sticky-top navbar-expand-sm navbar-dark" style="background-color: #0B0C10;">
                                ...
                                <div class="collapse navbar-collapse" id="collapsibleNavId">
                                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                                        <li class="nav-item active">
                                            <a class="nav-link" href="#stud_skills">Skills <span class="sr-only">(current)</span></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#stud_achivements">Achivements</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#stud_results">Results</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#stud_attendance">Attendance</a>
                                        </li>
                                    </ul>
                        ...
                        <div class="col" id="info_page">
                            ...
                            <div class="container-fluid text-center">
                                ...
                                <div class="jumbotron text-center" id="stud_skills">
                                    <h1>Skills</h1>
                                </div>
                                <table class="table">
                                    <thead>
                                ...
                                <table>
                                <div class="jumbotron text-center" id="stud_achivements">
                                    <h1>Achievements</h1>
                                </div>
                                <table class="table">
                                    <thead>
                                ...
                                <table>
                                <div class="jumbotron text-center" id="stud_results">
                                    <h1>Results</h1>
                                </div>
                                <table class="table" >
                                ...
                                <div class="jumbotron text-center" id="stud_attendance">
                                    <h1>Attendance</h1>
                                </div>
                                <table class="table" >
                                    <thead class="thead-dark">
